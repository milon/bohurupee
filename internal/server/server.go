...
<body>
  ...
  <p>OAuth/OIDC: <code>/{provider}/authorize</code>, <code>/{provider}/token</code>, <code>/{provider}/userinfo</code>, <code>/{provider}/.well-known/openid-configuration</code>, <code>/{provider}/jwks</code></p>
</body>
</html>
`
